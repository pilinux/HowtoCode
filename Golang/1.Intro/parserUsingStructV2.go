// continuation of parserUsingStruct.go
...
/*
./parserUsingStructV2 < parserUsingStruct.log1.txt
./parserUsingStructV2 < parserUsingStruct.log2.txt
./parserUsingStructV2 < parserUsingStruct.log3.txt
./parserUsingStructV2 < parserUsingStruct.log4.txt
*/
