// continuation of parserUsingStructV2.go
...
/*
./parserUsingFunc < parserUsingStruct.log1.txt
./parserUsingFunc < parserUsingStruct.log2.txt
./parserUsingFunc < parserUsingStruct.log3.txt
./parserUsingFunc < parserUsingStruct.log4.txt
*/
